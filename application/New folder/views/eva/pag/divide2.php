<!DOCTYPE html>
<!-- saved from url=(0063)https://evaclinics.com.sa/%d8%a7%d9%84%d9%84%d9%8a%d8%b2%d8%b1/ -->
...
<body
    class="rtl page-template-default page page-id-284 theme-betheme woocommerce-js noptin color-custom content-brightness-light input-brightness-light style-default button-flat layout-full-width no-content-padding hide-love no-shadows header-classic header-boxed sticky-tb-color ab-hide menu-line-below-80-1 menuo-no-borders subheader-both-left responsive-overflow-x-mobile mobile-tb-center mobile-side-slide mobile-mini-mr-lc tablet-sticky mobile-sticky mobile-header-mini mobile-icon-user-ss mobile-icon-wishlist-ss mobile-icon-search-ss mobile-icon-wpml-ss mobile-icon-action-ss be-page-284 be-reg-2736 mfn-all-shop-filters-disabled product-gallery-zoom mobile-row-2-products mfn-variable-swatches mfn-hidden-icon-count mfn-ajax-add-to-cart elementor-default elementor-kit-242 cht-in-desktop cht-landscape mfn-header-scrolled">
    ...
    <div id="Wrapper">
        ...
        <div id="Header_wrapper" class="bg-parallax" data-enllax-ratio="0.3" style="background-position: center 113px;">
                                            ...
                                            <div class="column mcb-column mcb-item-h4no2yfni one laptop-one tablet-one mobile-one column_column"
                                                ...
                                                <div
                                                    ...
                                                    <div class="column_attr mfn-inline-editor clearfix" style="">
                                                        ...
                                                        <p></p>
                                                        <p>في عيادات إيفا، نقدم خدمات إزالة الشعر بالليزر باستخدام أحدث
                                                            الأجهزة والتقنيات المتطورة التي تضمن نتائج فعالة وآمنة لجميع
                                                            أنواع البشرة. يوفر الليزر حلولاً دائمة للتخلص من الشعر غير
                                                            المرغوب فيه مع الحفاظ على نعومة البشرة.</p>
                                                        <p>نستخدم في عياداتنا تقنيات الليزر المتقدمة التي تتميز بالدقة
                                                            والفعالية في استهداف بصيلات الشعر دون الإضرار بالجلد المحيط،
                                                            مما يجعلها آمنة للاستخدام على مختلف مناطق الجسم بما في ذلك
                                                            الوجه، اليدين، الأرجل، والإبطين.</p>
                                                        <p>كما نقدم خدمات تجديد البشرة بالليزر والتي تساعد في تحسين مظهر
                                                            البشرة وتقليل التجاعيد والبقع الداكنة. يعمل فريقنا الطبي
                                                            المختص على تقديم استشارات شاملة لتحديد نوع العلاج الأنسب لكل
                                                            حالة بناءً على نوع البشرة واحتياجاتها.</p>
                                                        <p>إضافة إلى ذلك، نقدم علاجات إزالة الوشم بالليزر التي تتيح
                                                            التخلص من الوشوم غير المرغوب فيها بفعالية وأمان. نستخدم
                                                            تقنيات الليزر المتطورة التي تستهدف أصباغ الوشم بدقة عالية
                                                            دون التسبب في تلف الجلد.</p>
                                                        <p>تشمل خدمات الليزر لدينا أيضًا علاج الأوردة العنكبوتية وعلامات
                                                            التمدد باستخدام الليزر، مما يضمن نتائج ملموسة وتحسينات
                                                            ملحوظة في مظهر الجلد. نقدم أيضًا خدمات تفتيح البشرة وإزالة
                                                            التصبغات باستخدام تقنيات الليزر الحديثة التي تعمل على توحيد
                                                            لون البشرة وإعطائها مظهراً مشرقاً.</p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="image_wrapper "><img fetchpriority="high"
                                                                ...
                                                                src="assets_web/EVA_files/lab2_pic393.png"
                                                                class="scale-with-grid" alt="" style="" decoding="async"
                                                                srcset="https://evaclinics.com.sa/wp-content/uploads/2024/06/lab2_pic393.png 780w, https://evaclinics.com.sa/wp-content/uploads/2024/06/lab2_pic393-395x500.png 395w, https://evaclinics.com.sa/wp-content/uploads/2024/06/lab2_pic393-237x300.png 237w, https://evaclinics.com.sa/wp-content/uploads/2024/06/lab2_pic393-768x972.png 768w, https://evaclinics.com.sa/wp-content/uploads/2024/06/lab2_pic393-59x75.png 59w, https://evaclinics.com.sa/wp-content/uploads/2024/06/lab2_pic393-480x607.png 480w"
   ...
   <?php @$this->load->view('eva/Components/Footer.php');?>
    ...
    <div aria-disabled="false" class="mfn-header-login is-side woocommerce mfn-header-modal-login" aria-expanded="false"
        role="navigation" aria-label="shop account menu"><a
            href="https://evaclinics.com.sa/%d8%a7%d9%84%d9%84%d9%8a%d8%b2%d8%b1/#"
        ...
        <form class="woocommerce-form woocommerce-form-login login" method="post"
            ...
            <p class="form-row">
                ...
                <input type="hidden" name="woocommerce-login-nonce" value="941f06fcdb"><input type="hidden"
                    name="_wp_http_referer" value="/%D8%A7%D9%84%D9%84%D9%8A%D8%B2%D8%B1/">
    ...
    <link rel="stylesheet" id="wc-blocks-style-rtl-css" href="assets_web/EVA_files/wc-blocks-rtl.css" type="text/css"
        media="all">
    <link rel="stylesheet" id="mfn-post-local-styles-2841723212299-css" href="assets_web/EVA_files/post-284.css"
    ...
    <noscript><img height="1" width="1" style="display:none"
        ...
        data-load-time="1723212375742" height="0" width="0" src="assets_web/EVA_files/11312157904.html"
                ...
                <style>
                    ...
                    *,
                    ...
                    [data-theme=dark] {
                        ...
                        --nextui-border-width-medium: 2px;
                        --nextui-border-width-large: 3px;
                        --nextui-box-shadow-small: 0px 0px 5px 0px rgb(0 0 0 / .05), 0px 2px 10px 0px rgb(0 0 0 / .2), inset 0px 0px 1px 0px rgb(255 255 255 / .15);
                        --nextui-box-shadow-medium: 0px 0px 15px 0px rgb(0 0 0 / .06), 0px 2px 30px 0px rgb(0 0 0 / .22), inset 0px 0px 1px 0px rgb(255 255 255 / .15);
                        --nextui-box-shadow-large: 0px 0px 30px 0px rgb(0 0 0 / .07), 0px 30px 60px 0px rgb(0 0 0 / .26), inset 0px 0px 1px 0px rgb(255 255 255 / .15);
