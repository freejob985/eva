...
class Doctor extends CI_Controller {
    ...
    public function create()
    {
        ...
        // جلب بيانات الخدمات
        $data['services'] = $this->db->get('bserves')->result();
        ...
        // رفع الصورة
        $picture = $this->fileupload->do_upload('assets/images/doctor/', 'picture');
        if ($picture !== false && $picture != null) {
            $this->fileupload->do_resize($picture, 293, 350);
        }
        if ($picture === false) {
        ...
        $data['doctor'] = (object)$postData = [
            ...
            'branch_id'      => $this->input->post('branch_id', true),  // حفظ الفرع
            'specialization_id' => $this->input->post('specialization_id', true),  // حفظ التخصص
            'service_id'     => $this->input->post('service_id', true),  // حفظ الخدمة
