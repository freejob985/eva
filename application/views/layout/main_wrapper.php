...
<!-- ============================================================ -->
    ...
    <li class="treeview <?php echo (($this->uri->segment(1) == "department") || ($this->uri->segment(1) == "main_department") ? "active" : null) ?>">
        <a href="#">
            <i class="fa fa-sitemap"></i> <span><?php echo  "Branch"; ?></span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
        </a>
        <ul class="treeview-menu">
            ...
            if($this->permission->method('add_main_department','create')->access()){
            ?>
            <!-- <li class="<?php echo (($this->uri->segment(1) == "main_department")? "active" : null) ?>"><a href="<?php echo base_url("Branch/index") ?>"><?php echo  "main Branch" ; ?></a></li> -->
            <?php } ?>

            <?php
            if($this->permission->method('add_department','create')->access()){
            ?>
            <li class="<?php echo (($this->uri->segment(1) == "department" && $this->uri->segment(2) == "create")? "active" : null) ?>"><a href="<?php echo base_url("branch/create") ?>">add Branch </a></li>
            <?php } ?>
            ...
            if($this->permission->method('department_list','read')->access()  || $this->permission->method('department_list','update')->access() || $this->permission->method('department_list','delete')->access()){
            ?>
            <li class="<?php echo (($this->uri->segment(1) == "department" && $this->uri->segment(2) == "")? "active" : null) ?>"><a href="<?php echo base_url("branch/index") ?>"> Branch list </a></li> 
            <?php } ?>
...
<!-- ----------------------- -->
<li class="treeview <?php echo (($this->uri->segment(1) == "bserves") ? "active" : null) ?>">
    <a href="#">
        <i class="fa fa-sitemap"></i> <span><?php echo "Serves Management"; ?></span>
        <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
        </span>
    </a>
    <ul class="treeview-menu">
        ...
        <?php
        if ($this->permission->method('add_bserve','create')->access()) {
        ?>
        <li class="<?php echo (($this->uri->segment(1) == "bserves" && $this->uri->segment(2) == "create") ? "active" : null) ?>">
            <a href="<?php echo base_url("bserves/create") ?>"><?php echo "Add Bserve"; ?></a>
        </li>
        <?php } ?>

        <?php
        if ($this->permission->method('bserve_list','read')->access() || $this->permission->method('bserve_list','update')->access() || $this->permission->method('bserve_list','delete')->access()) {
        ?>
        <li class="<?php echo (($this->uri->segment(1) == "bserves" && $this->uri->segment(2) == "index") ? "active" : null) ?>">
            <a href="<?php echo base_url("bserves/index") ?>"><?php echo "Bserves List"; ?></a>
        </li>
        <?php } ?>
...
<li class="treeview <?php echo (($this->uri->segment(1) == "specialization") ? "active" : null) ?>">
    <a href="#">
        <i class="fa fa-sitemap"></i> <span><?php echo "Specialization "; ?></span>
        <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
        </span>
    </a>
    <ul class="treeview-menu">
        ...
        <?php
        if ($this->permission->method('add_specialization','create')->access()) {
        ?>
        <li class="<?php echo (($this->uri->segment(1) == "specialization" && $this->uri->segment(2) == "create") ? "active" : null) ?>">
            <a href="<?php echo base_url("specialization/create") ?>"><?php echo "Add Specialization"; ?></a>
        </li>
        <?php } ?>

        <?php
        if ($this->permission->method('specialization_list','read')->access() || $this->permission->method('specialization_list','update')->access() || $this->permission->method('specialization_list','delete')->access()) {
        ?>
        <li class="<?php echo (($this->uri->segment(1) == "specialization" && $this->uri->segment(2) == "index") ? "active" : null) ?>">
            <a href="<?php echo base_url("specialization/index") ?>"><?php echo "Specialization List"; ?></a>
        </li>
        <?php } ?>
